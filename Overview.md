...
In shortAssemble there is the very important concept introduce of limiting exponential branching. So if we can't find a matching sequence we can bottleneck the pass so the computations don't get stuck in exponential variations.
